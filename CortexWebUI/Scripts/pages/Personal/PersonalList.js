var Personallist = function () {
    var that = this;
    var pageInitObject = [];
    debugger;;

    var fillTable = function () {
        var table = $('#tablePersonalList');
        ...
        table.dataTable({
                ...
                buttons: [
                   {
                       ...
                       action: function (e, dt, node, config) {
                           window.location.href = $("#personalAddUrl").val();
                       }
                   }
                ],
                dom: {
            ...
            "columns": [
                        ...
                        { "data": "department", "name": "department", "bSortable": false, "Width": "10" },
                        { "data": "task", "name": "task", "bSortable": false, "Width": "10" },
                        { "data": "password", "name": "password", "bSortable": true, "Width": "10" },
                        { "data": "email", "name": "email", "bSortable": false, "Width": "10" },
                        { "data": "phone", "name": "phone", "bSortable": false, "Width": "10" },
    ...
    var refreshTable = function () {
        var oTable = $('#tablePersonalList').DataTable();
        oTable.ajax.reload();
    }
